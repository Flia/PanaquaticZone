...
{
    private static readonly List<Color> saltwaterZoneColors = [];
    private static int nextSaltwaterZoneColorIndex;
    ...
    private static IEnumerable<Color> SaltwaterZoneColors()
    {
